...
class ProfessionalExperience(models.Model):
    user = models.ForeignKey(
        User, related_name="professional_experiences", on_delete=models.CASCADE
    )
...
class ProfessionItem(models.Model):
    experience = models.ForeignKey(
        ProfessionalExperience, related_name="items", on_delete=models.CASCADE
    )
    description = models.TextField(null=True, blank=True)
...
class CV(models.Model):
    user = models.OneToOneField(
        User, related_name="resume_cv", on_delete=models.CASCADE
    )
